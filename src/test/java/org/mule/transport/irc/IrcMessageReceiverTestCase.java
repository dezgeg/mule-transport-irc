...
public class IrcMessageReceiverTestCase extends AbstractMessageReceiverTestCase
{
    ...
    public MessageReceiver getMessageReceiver() throws Exception
    {
        ...
        return new IrcMessageReceiver(endpoint.getConnector(), (Service) mockService.proxy(), endpoint);
    }
